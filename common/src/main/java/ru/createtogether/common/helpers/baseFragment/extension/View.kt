package ru.createtogether.common.helpers.baseFragment.extension
...
fun Fragment.onOpen(fragment: Fragment, fragmentManager: FragmentManager? = null, isAdd: Boolean = false) {
